...
CREATE TABLE `vendendor` (
  `idvendendor` int(11) NOT NULL AUTO_INCREMENT,
  `login` varchar(45) NOT NULL,
  `senha` varchar(45) NOT NULL,
  `nome` varchar(45) NOT NULL,
  `tipo` tinyint(4) DEFAULT '0',
  PRIMARY KEY (`idvendendor`)
...
INSERT INTO `vendendor` VALUES (1,'felipe','123','Felipe',0);
...
-- Dump completed on 2019-06-14  1:09:14
